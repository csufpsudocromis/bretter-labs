    ...
    <div>
      ...
      <div className="grid">
        <div>
          ...
          <p className="muted small">ISO files are stored in dedicated ISO storage and can be used by Create Image.</p>
        </div>
        <div>
                ...
                {editId === row.id ? (
                  ...
                  <>
                    ...
                    <div className="muted small">
                      {row.shared_catalog ? "Shared catalog" : "Namespace-owned catalog"}
                    </div>
                    <div className="actions">
