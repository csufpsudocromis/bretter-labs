...
- `ALERTMANAGER_WEBHOOK_MATCHERS` (default `severity="critical"`; keep paging high-signal)
...
- `ENABLE_POSTGRES_BACKUP_REPLICATION` (recommended for production DR; optional)
...
- `/admin/settings/runtime`: runtime/env/drift visibility plus writable global concurrency + idle-timeout controls
