...
# Keep only the latest successful run by default to reduce completed-pod noise.
SYSTEM_CRONJOB_SUCCESS_HISTORY_LIMIT="${SYSTEM_CRONJOB_SUCCESS_HISTORY_LIMIT:-1}"
SYSTEM_CRONJOB_FAILED_HISTORY_LIMIT="${SYSTEM_CRONJOB_FAILED_HISTORY_LIMIT:-1}"
SYSTEM_CRONJOB_TTL_SECONDS="${SYSTEM_CRONJOB_TTL_SECONDS:-300}"
